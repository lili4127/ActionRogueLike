...
#include "TLSaveGameSubsystem.generated.h"

class UTLSaveGame;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnSaveGameSignature, class UTLSaveGame*, SaveObject);
...
class ACTIONROGUELIKE_API UTLSaveGameSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
